...
namespace Subnetting
{
    public class SubnettingScanner
    {
        ...
        public string GetSMSubMask(int IpMaske)
        {
            string subMask = "";
            string ones = "";
            char pad = '0';

            for (int i = 0; i < IpMaske; i++)
                ones += 1;
        ...
        public byte[] GetNetzID(byte okt1Ip, byte okt2Ip, byte okt3Ip, byte okt4Ip, byte okt1SubMask, byte okt2SubMask, byte okt3SubMask, byte okt4SubMask)
        {
        ...
        public byte[] GetBcId(byte okt1SubMask, byte okt2SubMask, byte okt3SubMask, byte okt4SubMask, byte okt1NetzId, byte okt2NetzId, byte okt3NetzId, byte okt4NetzId)
        {
        ...
        public string ShowNewSubMask(int cidr_neu, char pad)
        {
            string ones = "";
